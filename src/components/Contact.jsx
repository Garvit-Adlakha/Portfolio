const Contact = () => {
  const socialLinks = [
    {
      href: "https://github.com/Garvit-Adlakha",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      href: "https://www.linkedin.com/in/garvit-adlakha-125795329/",
      icon: (
        <svg
          width="24"
          height="24"
  ...
  return (
    <section id="contact" className="section mb-20">
      <div className="container lg:grid lg:grid-flow-col lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
          <h2 className="headline-2 lg:amx-w-[12ch] reveal-up">contact me for collaboration</h2>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a key={key} href={href} className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transiiton-[background-color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80" >
                {icon}
              </a>
            ))}
          </div>
      ...
      <form 
      action="https://getform.io/f/aqoojnea"
      method="POST"
      className="xl:pl-10 2xl:pl-20 pb-20"
      >
      ...
      <button
        type="submit"
        className="btn btn-primary [&]:max-w-full w-full justify-center reveal-up bg-[#B8D1D0]"
      >
        Submit 
      </button>
      </form>
